...
parser.add_argument('--train_dir', type=str, default='D:/tmp/cifar10/cifar10_train', help='Directory where to write event logs and checkpoint.')

parser.add_argument('--max_steps', type=int, default=10000, help='Number of batches to run.')
...
def tower_loss(scope, images, labels):
    ...
    for l in losses + [total_loss]:
        ...
        print('[DEBUG] tower_loss func: l.op.name [', l.op.name, '], loss_name [', loss_name, '], value [', l, ']')
