...
NUM_CLASSES = 10    # TODO
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 5000    # TODO
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = 1000    # TODO
...
def read_imagenet(filename_queue):
    ...
    label_bytes = 8    # TODO
    result.height = IMAGE_ORI_SIZE
    result.width = IMAGE_ORI_SIZE
    result.depth = IMAGE_CHANNEL
    image_bytes = result.height * result.width * result.depth
    
    record_bytes = label_bytes + image_bytes

    # TODO could be replaced by TFReader
